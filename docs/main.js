...
let InMemoryDataService = class InMemoryDataService {
  createDb() {
    ...
    const cointypeList = [{
      ...
      description: 'The half dollar, sometimes referred to as the half for short or 50-cent piece, is a United States coin worth 50 cents, or one half of a dollar.',
      Img: 'halfdollar.png',
