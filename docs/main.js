...
const routes = [{
  ...
  path: 'bymonarch',
  loadComponent: () => __webpack_require__.e(/*! import() */ "src_app_bymonarch_bymonarch_bymonarch_component_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./bymonarch/bymonarch/bymonarch.component */ 4252)).then(mod => mod.ByMonarchComponent)
}, {
  path: 'monarchtype/:id',
  loadComponent: () => __webpack_require__.e(/*! import() */ "src_app_bymonarch_monarchType_monarch-type_monarch-type_component_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./bymonarch/monarchType/monarch-type/monarch-type.component */ 3256)).then(mod => mod.MonarchTypeComponent)
}, {
  path: 'britishcoins',
...
let ConfigService = class ConfigService {
  ...
  getCoinLisyByMonarchTypeSettings(database, countryName) {
    const url = countryName ? `api/${database}?monarchtype=${countryName}` : `api/${database}`;
    return this.http.get(url).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(this.handleError(`Error getting data from ${database}`, [])));
  }
...
let InMemoryDataService = class InMemoryDataService {
  createDb() {
    ...
    const monarchList = [{
      ...
      description: 'Charles II was King of Scotland from 1649 until 1651 and King of England, Scotland, and Ireland from the 1660 Restoration of the monarchy until his death in 1685. Charles II was the eldest surviving child of Charles I of England, Scotland and Ireland and Henrietta Maria of France.',
      Img: 'King_Charles_II.jpg',
      bottomContent: 'Charles II was the first king of England following his return from exile and the Restoration of the Monarchy in 1660.'
    }, {
      id: 2,
      country: 'unitedkingdom',
      countryId: 1,
      ...
      description: 'James VII and II was King of England and Ireland as James II and King of Scotland as James VII from the death of his elder brother, Charles II, on 6 February 1685. He was deposed in the Glorious Revolution of 1688. He was the last Catholic monarch of England, Scotland, and Ireland.',
      Img: 'James_II.jpg',
      bottomContent: 'James II was the last Catholic monarch in Britain and his short reign is known for his desire for religious tolerance.'
    }, {
      id: 3,
      country: 'unitedkingdom',
      countryId: 1,
      ...
      bottomContent: 'Religious divides dominated international relations and war was never far away. Our William III coins selection will take you closer to this turbulent period.'
    }, {
      id: 4,
      country: 'unitedkingdom',
      countryId: 1,
      ...
      Img: 'Queen_Anne.jpg',
      bottomContent: 'The reign of Queen Anne transformed Britain with the historic Acts of Union in 1707 that brought together the nations of England and Scotland in one kingdom, Great Britain.'
    }, {
      id: 6,
      country: 'unitedkingdom',
      countryId: 1,
      ...
      description: 'George II was King of Great Britain and Ireland, Duke of Brunswick-Lüneburg and a prince-elector of the Holy Roman Empire from 11 June 1727 until his death in 1760. Born and brought up in northern Germany, George is the most recent British monarch born outside Great Britain.',
      Img: 'George_II.jpg',
      ...
      bottomContent: 'He is the longest-reigning male monarch in British history.'
    }, {
      id: 9,
      country: 'unitedkingdom',
      countryId: 1,
      ...
      description: 'George IV was King of the United Kingdom of Great Britain and Ireland and King of Hanover from 29 January 1820 until his death in 1830.',
      Img: 'King_George_IV.jpg',
      bottomContent: 'George IV was the eldest child of King George III and Queen Charlotte.'
    }, {
      id: 10,
      country: 'unitedkingdom',
      countryId: 1,
      ...
      description: 'William IV was King of the United Kingdom of Great Britain and Ireland and King of Hanover from 26 June 1830 until his death in 1837. The third son of George III, William succeeded his elder brother George IV, becoming the last king and penultimate monarch of Britains House of Hanover.',
      Img: 'William_IV.jpg',
      bottomContent: 'The third son of George III, William succeeded his elder brother George IV, becoming the last king and penultimate monarch of Britains House of Hanover.'
    }, {
      id: 11,
      country: 'unitedkingdom',
      countryId: 1,
      ...
      description: 'Queen Victoria was crowned when she was just 18, and her reign lasted 63 years. She restored the image of the monarchy during a time of great economic, political and societal change. Lived: 1819–1901. Field: Royalty. Key fact: Reigned during a period of immense change which saw a great expansion of the British Empire.',
      Img: 'queen_victoria.jpg',
      bottomContent: 'She restored the image of the monarchy during a time of great economic, political and societal change.'
    }, {
      id: 12,
      country: 'unitedkingdom',
      countryId: 1,
      ...
      bottomContent: ' Edward became the second monarch of the House of Windsor.'
    }, {
      id: 15,
      country: 'unitedkingdom',
      countryId: 1,
      ...
      description: 'George VI (born December 14, 1895, Sandringham, Norfolk, England—died February 6, 1952, Sandringham) was the king of the United Kingdom from 1936 to 1952. George VI. Also called (1920–36): Prince Albert, duke of York. In full: Albert Frederick Arthur George.',
    ...
    const cointypeList = [{
      ...
      description: 'Tokens are coin-like objects, although not always made of metal, that serve as a money substitute. They are not issued by a governmental authority. Often they serve in times of a shortage of coins, and are usually meant for local use for a limited duration. Medals are never used as money.',
      Img: 'uktokens.jpg',
      ...
      description: 'In numismatics, the term milled coinage (also known as machine-struck coinage) is used to describe coins which are produced by some form of machine, rather than by manually hammering coin blanks between two dies (hammered coinage) or casting coins from dies.',
      Img: 'hammered.jpg',
      bottomContent: 'US Tokens and Medals'
    }];
    const coinList = [{
      ...
      "description": "This 1886 Philadelphia Mint Morgan dollar is ranked number 91 with a mintage of 19,963,886. It also holds the place of 25th out of 29 from Morgan dollars made at the Philadelphia Mint.",
      "frontImg": "1886f.jpg",
