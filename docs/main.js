...
const routes = [{
  ...
  loadComponent: () => __webpack_require__.e(/*! import() */ "src_app_worldcoin_worldcointype_worldcointype_component_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./worldcoin/worldcointype/worldcointype.component */ 8492)).then(mod => mod.WorldcointypeComponent)
}, {
  path: 'coin/:id',
...
let ConfigService = class ConfigService {
  ...
  getPageDeailsByCountrySettings(database, id) {
    const url = id ? `api/${database}/${id}` : `api/${database}`;
    return this.http.get(url).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(this.handleError(`Error getting data from ${database}`, [])));
  }
  getCoinListByCountrySettings(database, countryName) {
    const url = countryName ? `api/${database}?countryname=${countryName}` : `api/${database}`;
    return this.http.get(url).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(this.handleError(`Error getting data from ${database}`, [])));
  }
...
let InMemoryDataService = class InMemoryDataService {
  createDb() {
    ...
    // },
    {
      ...
      description: 'Austria, formally the Republic of Austria, is a landlocked country in Central Europe, lying in the Eastern Alps. It is a federation of nine federal states, one of which is the capital, Vienna, the most populous city and federal state.',
      Img: 'austria.png',
      ...
      country: 'belgium',
      name: 'Belgium',
      tagline: 'unity makes strength',
      title: 'l union fait la force',
      description: 'Kingdom of Belgium,[B] is a country in Northwestern Europe. The country is bordered by the Netherlands to the north, Germany to the east, Luxembourg to the southeast, France to the south, and the North Sea to the west. ',
      Img: 'belgium.png',
      bottomContent: ''
    }, {
      id: 5,
      country: 'ussr',
      name: 'USSR',
      tagline: 'Communist Party of the Soviet Union',
      title: 'The Soviet Union',
      description: 'The Soviet Union, officially the Union of Soviet Socialist Republics, was a transcontinental country that spanned much of Eurasia from 1922 to 1991..',
      Img: 'ussr.png',
      ...
      country: 'cuba',
      name: 'Cuba',
      tagline: 'Patria o Muerte, Venceremos',
      title: 'Homeland or Death, We Shall Overcome',
      description: 'Cuba, officially the Republic of Cuba, is an island country, comprising the island of Cuba, Isla de la Juventud, archipelagos, 4,195 islands and cays surrounding the main island. Cuba is located where the northern Caribbean Sea, Gulf of Mexico, and Atlantic Ocean meet.',
      Img: 'cuba.png',
      ...
      country: 'china',
      name: 'China',
      tagline: 'Peoples Republic of China',
      title: 'PRC',
      description: 'China, officially the Peoples Republic of China (PRC), is a country in East Asia. With a population exceeding 1.4 billion, it is the worlds second-most populous country.',
      Img: 'china.png',
      ...
      country: 'france',
      name: 'France',
      tagline: 'Liberté, Egalité, Fraternité',
      title: 'Liberty, Equality, Fraternity',
      description: 'France,officially the French Republic,[b] is a country located primarily in Western Europe. It also includes overseas regions and territories in the Americas and the Atlantic, Pacific and Indian oceans,[XII] giving it one of the largest discontiguous exclusive economic zones in the world',
      Img: 'france.png',
      ...
      country: 'iceland',
      name: 'Iceland',
      tagline: 'Better than space',
      title: 'Sagas of Icelanders',
      description: 'Iceland (Icelandic: Ísland is a Nordic island country between the North Atlantic and Arctic Oceans, on the Mid-Atlantic Ridge between North America and Europe.',
      Img: 'iceland.png',
      ...
      country: 'italy',
      name: 'Italy',
      tagline: 'LItalia e una Repubblica democratica, fondata sul lavoro',
      title: 'Italy is a democratic Republic, founded on labor',
      ...
      Img: 'italy.png',
      bottomContent: 'Assissi and Saint Caterina of Siena are the patron saints of Italy.'
    }, {
      id: 12,
      country: 'luxembourg',
      name: 'Luxembourg',
      tagline: 'Mir wëlle bleiwe wat mir sinn',
      title: 'we will remain what we are',
      ...
      name: 'Monaco',
      tagline: 'Deo Juvante',
      title: 'With Gods Help',
      description: 'Monaco, officially the Principality of Monaco, is a sovereign city-state and microstate on the French Riviera a few kilometres west of the Italian region of Liguria, in Western Europe, on the Mediterranean Sea.',
      Img: 'monaco.png',
      ...
      country: 'poland',
      name: 'Poland',
      tagline: 'Za wolność Naszą i Waszą',
      title: 'For our freedom and yours',
      description: 'Poland, officially the Republic of Poland, is a country in Central Europe. It is divided into 16 administrative voivodeship provinces, covering an area of 312,696 km². Poland has a population of over 38 million and is the fifth-most populous member state of the European Union.',
      Img: 'poland.png',
      ...
      country: 'switzerland',
      name: 'Switzerland',
      tagline: 'Unus pro Omnibus, Omnes pro Uno',
      ...
      country: 'yugoslavia',
      name: 'Yugoslavia',
      tagline: 'Brotherhood and unity',
      title: 'Brotherhood and unity',
      description: 'Yugoslavia was a country in Southeast and Central Europe that existed from 1918 to 1992. It came into existence in 1918 following World War I, under the name of the Kingdom of Serbs, Croats and Slovenes.',
      Img: 'yugoslavia.png',
      ...
      country: 'denmark',
      name: 'Denmark',
      tagline: 'Guds hjaelp, Folkets kaerlighed, Danmarks styrke.',
      title: 'Gods Help, the Peoples Love, Denmarks Strength.',
      description: 'Denmark is a Scandinavian country comprising the Jutland Peninsula and numerous islands. Its linked to nearby Sweden via the Öresund bridge. Copenhagen, its capital, is home to royal palaces and colorful Nyhavn harbor, plus the Tivoli amusement park and the iconic Little Mermaid statue. Odense is writer Hans Christian Andersens hometown, with a medieval core of cobbled streets and half-timbered houses. ',
      Img: 'denmark.png',
      ...
      country: 'norway',
      name: 'Norway',
      tagline: 'Alt for Norge',
      title: 'All for Norway',
      ...
      country: 'sweden',
      name: 'Sweden',
      tagline: 'För Sverige – i tiden',
      title: 'For Sweden – with the Times',
    ...
    const cointypeList = [{
      ...
      description: 'The British half crown was a denomination of sterling coinage worth 1⁄8 of one pound, or two shillings and six pence (abbreviated "2/6", familiarly "two and six"), or 30 pre-decimal pence. The half crown was first issued in 1549, in the reign of Edward VI. No half crowns were issued in the reign of Mary, but from the reign of Elizabeth I half crowns were issued in every reign except that of Edward VIII, until the coins were discontinued in 1970.',
      Img: 'halfcrown.jpg',
    ...
    const coinList = [{
      ...
      description: "William IV (William Henry; 21 August 1765 \u001a 20 June 1837) was King of the United Kingdom of Great Britain and Ireland and King of Hanover from 26 June 1830 until his death in 1837. The third son of George III, William succeeded his elder brother George IV, becoming the last king and penultimate monarch of Britain's House of Hanover.",
      frontImg: '1834f.jpg',
      frontTitle: 'GEORGIUS',
      frontDescription: 'George the Fourth by the Grace of God',
      backImg: '1834b.jpg',
      ...
      tagline: '5 shilling',
      title: 'Austria',
      description: 'Standard circulation 5 Schilling coin',
      frontImg: '5sh1961f.jpg',
      frontTitle: 'REPUBLIK ',
      frontDescription: 'A Lipizzaner horse with its rider from the Spanish Court Riding School.',
      backImg: '5sh1961b.jpg',
      backTitle: 'Hans Köttenstorfer',
      backDescription: 'The Austrian escutcheon, the face value and two laurel branches',
      bottomContent: 'SCHILLING',
      price: '10.00',
      ebay: ''
    }, {
      id: 193,
