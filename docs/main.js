(self["webpackChunkyoski"] = self["webpackChunkyoski"] || []).push([["main"],{
...
const configuration = {
  header: {
    heading: 'My website',
    headingtext: 'Yoski is a free landing page template you can use for your projects.',
