	...
	createDb() {
		...
		const coinList = [
			...
			},
			{
				...
				description:
					'1817 King George III Silver Halfcrown Coin Pistrucci Small Laureate Head.',
				frontImg: '1817f.jpg',
			...
			},
			{
				...
				title: 'Lipizzaner',
				description:
					'The Lipizzaner is a horse breed from Slovenia, culturally linked to the Spanish School of Vienna.',
			...
			},
			{
				...
				frontDescription:
					'The denomination in the center above the date with the country name above around the rim',
			...
			},
			{
				...
				title: 'norway',
				description:
					'Haakon VII was King of Norway from November 1905 until his death in September 1957. Originally a Danish prince, he was born in Copenhagen as the son of the future Frederick VIII of Denmark and Louise of Sweden.',
			...
			},
			{
				...
				title: 'poland',
				description:
					'Polands frontiers were settled in 1922 and internationally recognized in 1923',
			...
			},
			{
				...
				frontTitle: 'FRANCO',
				frontDescription:
					'The portrait of Francisco Franco facing right with the date of the start of the series below',
				backImg: '19575pb.jpg',
			...
			},
			{
				...
				title: '1955 1 Krona',
				description:
					"Gustaf VI Adolf was King of Sweden from 29 October 1950 until his death in 1973. He was the eldest son of Gustaf V and his wife, Victoria of Baden. Before Gustaf Adolf ascended the throne, he had been crown prince for nearly 43 years during his father's reign.",
			...
			},
			{
				...
				title: '1919 2 ÖRE',
				description:
					'Gustaf V was King of Sweden from 8 December 1907 until his death in 1950. He was the eldest son of King Oscar II of Sweden and Sophia of Nassau, a half-sister of Adolphe, Grand Duke of Luxembourg.',
			...
			},
			{
				...
				title: '1954 5 Rappen',
				description:
					'5 rappen 1954 ; Period, Confoederatio Helvetica 1917 - 1967 ; Coin type, Circulation coins ; Denomination, 5 rappen ; Currency rate, 0.05 CHF = 0.05 USD ; Year, 1954.',
			...
			},
			{
				...
				frontTitle: '1 Dinar',
				frontDescription:
					'The name of the country above the old arms of Yugoslavi',
				backImg: '19531db.jpg',
			...
			},
			{
				...
				description:
					'Victor Emmanuel III, born Vittorio Emanuele Ferdinando Maria Gennaro di Savoia, was King of Italy from 29 July 1900 until his abdication on 9 May 1946. A member of the House of Savoy, he also reigned as Emperor of Ethiopia and King of the Albanians.',
			...
			},
			{
				...
				title: '1863 1 Lira',
				description:
					'Victor Emmanuel II was King of Sardinia from 23 March 1849 until 17 March 1861, when he assumed the title of King of Italy and became the first king of an independent, united Italy since the 6th century, a title he held until his death in 1878.',
			...
			},
			{
				...
				frontDescription:
					'Woman head with oak wreath in hair facing right. Designer and engraver names below.',
			...
			},
			{
				...
				frontTitle: 'Victor Emmanuel III',
				frontDescription:
					'Head of King Vittorio Emanuele III facing right and the name of the engraver below the neck',
			...
			},
			{
				...
				frontTitle: '2 Lira',
				frontDescription:
					'Head of King Vittorio Emanuele III facing right.Below the neck the name of the engraver',
				backImg: '19392lb.jpg',
				backTitle: 'Romagnoli',
				backDescription:
			...
			},
			{
				...
				frontTitle: 'REPUBLIK·ÖSTERREICH',
				frontDescription:
					'Austria coat of arms (an eagle carries the Austrian escutcheon)',
			...
			},
			{
				...
				frontTitle: 'REPUBLIK·ÖSTERREICH',
				frontDescription:
					'Cross potent (also known as a crutch cross is a form of heraldic cross)',
			...
			},
			{
				...
				frontTitle: 'REPUBLIK·ÖSTERREICH',
				frontDescription:
					'The double headed imperial eagle with Habsburg-Lorraine shield on breast.',
				backImg: '18951hb.jpg',
				backTitle: 'Neudeck',
				backDescription:
			...
			},
			{
				...
				frontTitle: '20 Kreuzers',
				frontDescription:
					'Laureate head facing right. Legend around (starts 8h)',
			...
			},
			{
				...
				frontTitle: '20 Kreuzers',
				frontDescription:
					'The laureate bust of King Franz Joseph I facing right',
				backImg: '18585kb.jpg',
				backTitle: 'Francis Joseph I',
			...
			},
			{
				...
				frontTitle: 'CAROLVS·II',
				frontDescription:
					'Crowned bust of King Charles II left to bottom edge of coin, single-arched crown, no inner circle, denomination behind head to right, legend above, outer toothed border both sides.',
			...
			},
			{
				...
				frontTitle: 'William III',
				frontDescription:
					'First conjoined laureate busts of King William and Queen Mary, legend around.',
				backImg: '16893pb.jpg',
				backTitle: 'Mary II',
				backDescription:
					'Central denomination below crown dividing date, legend around.',
			...
			},
			{
				...
				frontTitle: '1st bust',
				frontDescription:
					'First draped bust of Queen Anne left, legend around.',
				backImg: '17072pb.jpg',
				backTitle: 'Maundy',
				backDescription:
					'Central denomination below crown dividing date, legend around.',
			...
			},
			{
				...
				frontDescription:
					'Young laureate and draped bust of King George II left, legend around.',
				backImg: '17324pb.jpg',
				backTitle: 'Maundy',
				backDescription:
					'Central denomination below crown dividing date, legend around.',
			...
			},
			{
				...
				frontTitle: 'GEORGIVS·II· DEI·GRATIA·',
				frontDescription:
					'Laureate and draped bust of King George II left, legend around',
				backImg: '17463pb.jpg',
				backTitle: 'Maundy',
				backDescription:
					'Central denomination below crown dividing date, legend around.',
			...
			},
			{
				...
				frontDescription:
					'Young laureate and draped bust of King George III right, legend around.',
				backImg: '17623pb.jpg',
				backTitle: 'Maundy',
				backDescription:
					'Central denomination below crown dividing date, legend around.',
			...
			},
			{
				...
				frontDescription:
					'Laureate bust of King George IV left, legend around.',
				backImg: '18272pb.jpg',
				backTitle: 'Maundy',
				backDescription:
					'Crowned denomination dividing date within oak wreath.',
			...
			},
			{
				...
				frontTitle: 'GULIELMUS IIII',
				frontDescription:
					'Uncrowned portrait of King William IV facing right, legend around.',
				backImg: '18331pb.jpg',
				backTitle: 'Maundy',
				backDescription:
					'Crowned denomination dividing date within oak wreath.',
